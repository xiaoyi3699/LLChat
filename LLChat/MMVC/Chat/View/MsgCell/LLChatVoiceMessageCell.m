...
@implementation LLChatVoiceMessageCell {
...
- (void)setConfig:(LLChatMessageModel *)model isShowName:(BOOL)isShowName {
    ...
    if (model.isSender) {
        ...
        _voiceImageView.image = [UIImage imageNamed:@"ll_chat_voice_2"];
        ...
        _voiceImageView.image = [UIImage imageNamed:@"ll_chat_voice_1"];
