...
@interface LLChatSqliteManager () {
    NSString *_dataBasePath;
    sqlite3 *_sql3;
}
@end

@implementation LLChatSqliteManager
...
+ (instancetype)defaultManager{
    ...
    static LLChatSqliteManager *manager;
    dispatch_once(&onceToken, ^{
        manager = [[LLChatSqliteManager alloc] init];
    });
    return manager;
}
